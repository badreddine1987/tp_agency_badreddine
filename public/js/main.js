$(document).ready(() => {
  // Récupérer le container pour les formulaires des etapes
  let containerEtapes = $(".container-etape");

  // Créer le bouton d'ajout des etapes
  ...
  function addRemoveButton(card) {
    ...
    let removeButton = $('<a href="#">Supprimer etapes </a>');

    // J'ajoute le bouton de suppression à la card passé en paramètre
